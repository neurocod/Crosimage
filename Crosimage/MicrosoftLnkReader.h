...
class MicrosoftLnkReader {
	public:
		...
		static const int CorrectSignature = 0x4C000000;
		quint32 _signature;
		quint8 _guid[16];
		...
		quint32 _hotKey;//The hot key assigned for this shortcut
		quint32 _reserved1;//Reserved - Always 0
		quint32 _reserved2;//Reserved - Always 0
